...
class PromptsWidget extends StatefulWidget {
  const PromptsWidget({Key? key}) : super(key: key);

  @override
  _PromptsWidgetState createState() => _PromptsWidgetState();
}
        ...
        child: GestureDetector(
          ...
          child: WillPopScope(
            ...
            child: Scaffold(
              ...
              appBar: MediaQuery.of(context).size.width >= 768.0
                  ? AppBar(
                      backgroundColor:
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 4.0),
                                          child: Text(
                                            'Share your own topic of interest and start ',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily:
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowChoiceChips(
                                            options: [
                                              ...
                                              ChipData('Passive'),
                                              ChipData('Informative')
                                            ],
                                            onChanged: (val) => setState(() =>
                                                _model.toneOfVoiceValue =
                                                    val?.first),
                                            selectedChipStyle: ChipStyle(
                                              backgroundColor:
                                                  Color(0x4D097E3A),
